...
use super::{
    ...
    sft::VoxelModelSFT,
    voxel::{
        VoxelMaterialSet, VoxelModelGpuImpl, VoxelModelGpuImplConcrete, VoxelModelImpl,
        VoxelModelImplMethods,
    },
...
use crate::{
    ...
    engine::{
        ...
        voxel::thc::{VoxelModelTHC, VoxelModelTHCCompressed},
    },
};
...
use crate::{
    ...
    engine::{
        ...
        resource::{Res, ResMut},
        voxel::{voxel::VoxelModelEdit, voxel_world, voxel_world_gpu::VoxelWorldGpu},
...
impl VoxelWorld {
    ...
    pub fn get_model<T: VoxelModelImplMethods>(&self, id: VoxelModelId) -> &T {
        self.registry.get_model(id)
    }

    pub fn get_dyn_model(&self, id: VoxelModelId) -> &dyn VoxelModelImplMethods {
        self.registry.get_dyn_model(id)
    }

    pub fn get_dyn_model_mut(&mut self, id: VoxelModelId) -> &mut dyn VoxelModelImplMethods {
